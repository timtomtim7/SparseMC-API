...
//	public static final  String KOTLIN_EAP_REPO = "http://dl.bintray.com/kotlin/kotlin-eap/";
	...
	static void load(File folder) {
		...
		forceVersions.put(KOTLINX_COROUTINES_CORE, "1.1.1");
		forceVersions.put(KOTLIN_STDLIB, "1.3.21");
		forceVersions.put(KOTLIN_STDLIB_JDK8, "1.3.21");
		forceVersions.put(KOTLIN_STDLIB_JDK7, "1.3.21");
		forceVersions.put(KOTLIN_REFLECT, "1.3.21");
