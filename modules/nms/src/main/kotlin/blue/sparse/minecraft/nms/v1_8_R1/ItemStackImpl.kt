...
class ItemStackImpl : ItemStackNMS {
	private val craftMetaItemClass by lazy { Class.forName("org.bukkit.craftbukkit.v1_8_R1.inventory.CraftMetaItem") }
	...
	private fun nmsFromNBT(compound: Compound): net.minecraft.server.v1_8_R1.ItemStack {
		return net.minecraft.server.v1_8_R1.ItemStack.createStack(NBTUtil.valueToNBTBase(compound) as NBTTagCompound)
	}
	...
	internal val ItemStack.handle: net.minecraft.server.v1_8_R1.ItemStack
		get() {
			val craft = asCraftItemStack(this)
			val handleField = craft.javaClass.getDeclaredField("handle")
			handleField.isAccessible = true

			val handleValue = handleField.get(craft) as net.minecraft.server.v1_8_R1.ItemStack?
